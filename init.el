...
;; (require 'init-spelling) ;; - deleted by guli
(require 'init-xterm)
...
;;----------------------------------------------------------------------------
(setq user-customize-file
     (concat "~/.emacs.d/init." (or user-login-name "") ".el"))

(if (file-exists-p user-customize-file) (load-file user-customize-file))
